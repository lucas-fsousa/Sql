...
namespace PublicUtility.Sql.SqlServer {
  public partial class DB {
    ...
    public async ValueTask<string> ExecCmdAsync(SqlCommand command, CancellationToken cancellationToken = default) {
    ...
    public async ValueTask<string> ExecQueryAsync(string query, CancellationToken cancellationToken = default) => await ExecCmdAsync(new SqlCommand(query), cancellationToken);

    public async ValueTask<DataTable> ReturnDataAsync(SqlCommand command, CancellationToken cancellationToken = default) {
    ...
    public async ValueTask<DataTable> ReturnDataAsync(string query, CancellationToken cancellationToken = default) => await ReturnDataAsync(new SqlCommand(query), cancellationToken);
    ...
    public async ValueTask<T> ReturnDataAsync<T>(SqlCommand command, CancellationToken cancellationToken = default) where T : IEnumerable {
